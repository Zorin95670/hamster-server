...
public abstract class PredicateFilter implements IPredicateFilter {
    ...
    public void setOperatorFromValue(final int index) {
        ...
        if (this.values[index].toLowerCase().startsWith(PredicateOperator.SUPERIOR.getValue())) {
            this.setOperator(index, PredicateOperator.SUPERIOR);
            this.setValue(index, this.values[index].substring(PredicateOperator.SUPERIOR.getValue().length()));
        }
        if (this.values[index].toLowerCase().startsWith(PredicateOperator.INFERIOR.getValue())) {
            this.setOperator(index, PredicateOperator.INFERIOR);
            this.setValue(index, this.values[index].substring(PredicateOperator.INFERIOR.getValue().length()));
        }
